...
public class LoginController {
	...
	// Logger log= LogManager.getLogger(UserRepository.class); or we can write like
	// below
	...
	// public LoginController (LoginService loginService, UserRepository
	// userRepository) {
	...
	public void addLogin(@Valid @RequestBody UserEntity login) {
		...
		try {
			...
			// return ResponseHandler.genarateResponse("Successfully added data!",
			// HttpStatus.OK, result);
		} catch (Exception e) {
